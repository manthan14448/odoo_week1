...
class EstateProperty(models.Model):
    ...
    garden_orientation=fields.Selection([('North','Garden is North side'),('South','Garden is South side'), ('East','Garden is East side'),('West','Garden is West side')],string="Property Garden Orientation")
